...
def list_files(relative_path: str = "") -> list[str]:
    ...
    Args:
        relative_path: Relative path within the sandbox (default: root)
...
def read_file(relative_path: str) -> str:
    ...
    Args:
        relative_path: Relative path to the file within the sandbox
...
def create_directory(relative_path: str) -> str:
    ...
    Args:
        relative_path: Relative path to the directory within the sandbox

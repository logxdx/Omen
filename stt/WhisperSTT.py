...
WHISPER_MODEL_PATH = MODELS_PATH / "whisper"
...
class WhisperSTT:
    ...
    def __init__(
        ...
        - silero_use_onnx (bool, default=True): Enables usage of the
        ...
        - post_speech_silence_duration (float, default=0.5): Duration in
